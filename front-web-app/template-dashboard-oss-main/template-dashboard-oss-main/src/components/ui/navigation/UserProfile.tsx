...
export const UserProfileDesktop = () => {
  ...
  useEffect(() => {
    ...
    setEmail(storedEmail || "Guest"); // Set "Guest" if no email is found
  }, []);
      ...
      >
        <span className="flex items-center gap-3">
          <span
            ...
            aria-hidden="true"
          >
            {email ? email.charAt(0).toUpperCase() : "G"} {/* Show the first letter */}
          </span>
          <span>{email || "Loading..."}</span> {/* Show the email or a loading placeholder */}
        </span>
        <RiMore2Fill
